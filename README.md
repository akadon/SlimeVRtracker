...
- **Platforms**: ESP8266 (espressif8266 4.2.1), ESP32 (espressif32 6.7.0)
- **CI**: GitHub Actions
...
├── .github/
│   └── workflows/
│       └── actions.yml          # CI build pipeline
├── boards/                      # Board definition files
├── ci/                          # CI helper scripts
├── include/                     # PlatformIO include directory
├── lib/                         # IMU and utility libraries
│   ├── bno055_adafruit/         # Adafruit BNO055 driver
│   ├── bno080/                  # BNO080 driver
│   ├── ICM20948/                # ICM-20948 driver
│   ├── mpu6050/                 # MPU-6050 driver
│   ├── mpu9250/                 # MPU-9250 driver
│   ├── magnetometers/           # Magnetometer drivers
│   ├── vqf/                     # VQF sensor fusion
│   ├── magneto/                 # Magnetometer calibration
│   ├── math/                    # Math utilities
│   ├── i2cdev/                  # I2C device library
│   ├── i2cscan/                 # I2C scanner
│   ├── mpu6050offsetfinder/     # MPU6050 offset calibration
│   └── ota/                     # OTA update support
├── scripts/                     # Build helper scripts
├── src/
│   ├── main.cpp                 # Entry point
│   ├── defines.h                # Firmware configuration
│   ├── debug.h                  # Debug flags
│   ├── credentials.h            # WiFi/OTA credentials
│   ├── boards/                  # Board pin definitions
│   ├── configuration/           # Runtime configuration
│   ├── sensors/                 # Sensor implementations
│   ├── sensorinterface/         # Sensor abstraction layer
│   ├── motionprocessing/        # Motion/fusion processing
│   ├── network/                 # WiFi and UDP networking
│   ├── serial/                  # Serial communication
│   ├── logging/                 # Logging utilities
│   ├── debugging/               # Debug utilities
│   └── status/                  # Status LED management
├── test/                        # Unit tests
├── platformio.ini               # PlatformIO project config
├── board-defaults.json          # Default board configurations
├── board-defaults.schema.json   # JSON schema for board defaults
...
| Board Environment | Platform | Chip |
|---|---|---|
| BOARD_WEMOSD1MINI | ESP8266 | ESP-12E |
| BOARD_NODEMCU | ESP8266 | ESP-12E |
| BOARD_TTGO_TBASE | ESP8266 | ESP-12E |
| BOARD_WEMOSWROOM02 | ESP8266 | ESP-12E |
| BOARD_ESP01 | ESP8266 | ESP-01 |
| BOARD_SLIMEVR | ESP8266 | ESP-12E |
| BOARD_SLIMEVR_V1_2 | ESP8266 | ESP-12E |
| BOARD_WROOM32 | ESP32 | ESP32 |
| esp32c3 (default) | ESP32 | ESP32-C3 |
| BOARD_BEETLE32C3 | ESP32 | ESP32-C3 |
| BOARD_ESP32C3DEVKITM1 | ESP32 | ESP32-C3 |
| BOARD_ESP32C6DEVKITC1 | ESP32 | ESP32-C6 |
| BOARD_XIAO_ESP32C3 | ESP32 | ESP32-C3 |
| BOARD_ESP32S3_SUPERMINI | ESP32 | ESP32-S3 |
